...
<style>
    ...
    /* Result Header */
    .result-header {
        background: {{ $passed ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'linear-gradient(135deg, #f44336 0%, #e91e63 100%)' }};
        color: white;
        padding: 2rem 1.5rem;
        border-radius: 15px;
        text-align: center;
    ...
    <div class="container result-container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #4caf50;">{{ $correctCount }}/{{ $quiz->questions->count() }}</div>
            </div>
            <div class="stat-card">
        ...
        <div class="action-buttons">
            ...
            @if($quiz->lesson)
                <a href="{{ route('client.lessons.show', $quiz->lesson->id) }}" class="btn-action btn-primary" aria-label="Back to lesson">
                    📚 Back to Lesson
                </a>
            @endif
